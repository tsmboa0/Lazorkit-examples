    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <main className="max-w-6xl mx-auto px-4 py-16">
        ...
        <section className="text-center mb-20 relative">
          {/* Mobile Examples Badge - Floating */}
          <button
            onClick={() => {
              document.getElementById('mobile-examples')?.scrollIntoView({
                behavior: 'smooth'
              });
            }}
            className="
              ...
              hover:bg-purple-500/30 hover:ring-purple-500/60
              transition-all duration-200 cursor-pointer
              animate-pulse
            "
          >
            <span>📱</span>
            <span>Mobile Examples Available</span>
            <span className="text-purple-400">↓</span>
          </button>

          {/* Logo */}
          <div className="inline-flex items-center justify-center h-24 w-24 rounded-3xl bg-gradient-to-br from-rose-500/20 to-orange-500/20 ring-1 ring-rose-500/30 mb-8 mt-8">
          ...
          <div className="flex items-center justify-center gap-3 mb-8">
            <span className="px-3 py-1.5 rounded-full bg-rose-500/20 ring-1 ring-rose-500/30 text-rose-300 text-sm font-medium">
              🌐 Web (Next.js)
            </span>
            <span className="px-3 py-1.5 rounded-full bg-purple-500/20 ring-1 ring-purple-500/30 text-purple-300 text-sm font-medium">
              📱 Mobile (React Native)
            </span>
          </div>
        ...
        <section className="mb-20">
          ...
          <div className="rounded-2xl bg-black/40 ring-1 ring-white/10 p-6 font-mono text-sm">
            <div className="text-zinc-500 mb-4"># Clone and run (Web)</div>
            <div className="text-zinc-300">git clone https://github.com/your-repo/lazorkit-examples.git</div>
            <div className="text-zinc-300">cd lazorkit-examples/web</div>
        ...
        <section id="mobile-examples" className="mb-20">
          <h2 className="text-2xl font-semibold text-center mb-4">
            📱 Mobile Examples
          </h2>
          <p className="text-zinc-400 text-center mb-8 max-w-xl mx-auto">
            We also have React Native examples using Expo. Test them on your phone
            with Expo Go!
          </p>

          <div className="rounded-2xl bg-gradient-to-br from-purple-500/10 to-blue-500/10 ring-1 ring-purple-500/30 p-8">
            {/* How to Test */}
            <h3 className="text-lg font-semibold mb-6">How to Test Mobile Examples</h3>

            <div className="grid gap-6 md:grid-cols-2 mb-8">
              {/* Step 1: Download */}
              <div className="flex gap-4">
                <div className="flex-shrink-0 h-10 w-10 rounded-xl bg-purple-500/20 flex items-center justify-center text-lg font-bold text-purple-400">
                  1
                </div>
                <div>
                  <h4 className="font-medium text-white mb-1">Download Expo Go</h4>
                  <p className="text-sm text-zinc-400 mb-2">
                    Get the free Expo Go app on your phone
                  </p>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-medium text-white mb-1">Start Mobile Server</h4>
                  <p className="text-sm text-zinc-400">
                    Run these commands in your terminal:
                  </p>
                  <div className="mt-2 px-3 py-2 rounded-lg bg-black/40 font-mono text-xs text-zinc-300">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-medium text-white mb-1">Scan QR Code</h4>
                  <p className="text-sm text-zinc-400">
                    <strong className="text-white">iOS:</strong> Use Camera app to scan<br />
                    <strong className="text-white">Android:</strong> Use Expo Go app to scan
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-medium text-white mb-1">Explore Examples</h4>
                  <p className="text-sm text-zinc-400">
                    The app will open with 3 examples: Connect, Balance, Send
                  </p>
                </div>
              </div>
            </div>
