# Lazorkit SDK Examples Web

A comprehensive collection of examples demonstrating how to use the [Lazorkit SDK](https://lazorkit.com) for passkey-based wallet authentication on the web.
